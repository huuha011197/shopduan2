			...
			<div class="w-size13 p-t-30 respon5">
				<div class="wrap-slick3 flex-sb flex-w">
					...
					<div class="slick3">
						...
						<div class="item-slick3" data-thumb="{{asset('client/images/'. $product_detail->image)}}">
							<div class="wrap-pic-w img-detail">
								<img src="{{asset('client/images/'. $product_detail->image)}}" alt="IMG-PRODUCT">
							</div>
						</div>
						{{-- @endforeach --}}
					</div>
					...
					<div class="flex-r-m flex-w p-t-10">
						<div class="w-size16 flex-m flex-w">
							...
							<div class="btn-addcart-product-detail size9 trans-0-4 m-t-10 m-b-10">
								<!-- Button -->
								<a href="{{ Route('themgiohang', $product_detail->id)}}">
